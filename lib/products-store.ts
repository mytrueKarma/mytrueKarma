...
const defaultProducts: Product[] = [
  ...
  // Immobilien
  {
    ...
    rating: 4.9,
    reviews: 12,
    image: "/immobilien-penthouse.jpg",
    category: "Immobilien",
    inStock: true,
    type: "immobilie",
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 15,
    image: "/immobilien-apartment.jpg",
    category: "Immobilien",
    inStock: true,
    type: "immobilie",
...
const CURRENT_VERSION = "2.3"; // Erhöhe diese Version, wenn du Produkte aktualisierst
