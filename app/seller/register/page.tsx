  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Wir werden Ihren Antrag innerhalb von 2-3 Werktagen prüfen.",
      });
    ...
    switch (step) {
      ...
      case 5:
        return (
          ...
          formData.socialMissionAccepted
        );
      default:
        return false;
    }
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground text-lg">
          Schließen Sie sich unserer sozialen Gemeinschaft an und machen Sie
          einen Unterschied
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <Card className="text-center p-6 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-sm text-muted-foreground">
            Erreichen Sie neue Kunden und steigern Sie Ihren Umsatz
          </p>
        </Card>
        ...
        <Card className="text-center p-6 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-sm text-muted-foreground">
            Teil einer Bewegung für positive Veränderung werden
          </p>
        </Card>
        ...
        <Card className="text-center p-6 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-sm text-muted-foreground">
            Transparente Plattform mit fairen Gebühren
          </p>
        </Card>
      </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  Erforderlich für Unternehmen mit Umsatzsteuerpflicht
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="expectedMonthlyVolume">
                  Erwartetes monatliches Verkaufsvolumen *
                </Label>
                <Select
                  value={formData.expectedMonthlyVolume}
                  onValueChange={(value) =>
                    handleInputChange("expectedMonthlyVolume", value)
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleInputChange(
                        "socialImpactCommitment",
                        checked as boolean
                      )
                    }
                  />
                  <Label htmlFor="socialImpactCommitment">
                    Ich möchte einen Teil meiner Verkäufe für soziale Projekte
                    spenden
                  </Label>
                </div>
                ...
                {formData.socialImpactCommitment && (
                  <div className="space-y-2 ml-6">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Empfohlen: 5-10% für maximale soziale Wirkung
                    </p>
                  </div>
                )}
              </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <p className="text-muted-foreground">
                Laden Sie relevante Dokumente hoch, um Ihren Verkäufer-Status zu
                verifizieren. Diese Dokumente sind optional, können aber den
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="taxDocument">
                    Steuerliche Bescheinigung (optional)
                  </Label>
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    <Upload className="h-8 w-8 mx-auto text-gray-400 mb-2" />
                    <Label
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="socialMissionAccepted">
                      Ich unterstütze die soziale Mission von mytrueKarma und
                      verpflichte mich zu transparentem und ethischem Handel *
                    </Label>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <ul className="text-sm text-green-700 space-y-1">
                  ...
                  <li>
                    • Nach Genehmigung können Sie sofort mit dem Verkauf
                    beginnen
                  </li>
                  <li>
