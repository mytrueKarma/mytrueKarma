...
export default function ExclusiveDesignsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mb-2">Exclusive Designs</h1>
        <p className="text-muted-foreground">
          Limitierte Design-Kollektionen mit maximalem Social Impact - 50% der
          Erlöse gehen an soziale Projekte
        </p>
      </div>
